        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
              Desenvolvedor Front-End apaixonado por criar experiências digitais incríveis. Sempre em busca de novos desafios e aprendizados.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li>
                <a href="mailto:olucasklein@hotmail.com" className="hover:text-white transition-colors">
                  olucasklein@hotmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/5522999165664" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  +55 22 99916-5664
                </a>
              </li>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} Lucas Klein. Todos os direitos reservados.
            </p>
